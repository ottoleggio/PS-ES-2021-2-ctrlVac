 ...
 */
@WebServlet(name = "listarAgendaRealizada", urlPatterns = { "/listarAgendaRealizada" })
public class ListarAgendaCancelada extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			List<Agenda> agenda = adao.listarRealizadas();
